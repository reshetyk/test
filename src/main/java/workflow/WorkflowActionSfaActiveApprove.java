...
import static entity.WorkflowDecisionStatus.APPROVED;
 ...
 */
@Service
public class WorkflowActionSfaActiveApprove<T extends WorkflowEntity> extends WorkflowActionAbstract<T> {
...
//        repo.save(original.get());
    ...
    public boolean isApplicableFor(T entity) {
        return entity.getStatus() == SFA && entity.getDecision().getStatus() == APPROVED;
    }
}
